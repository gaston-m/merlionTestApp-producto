  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="merlionTestApp.product.home.createOrEditLabel">
            <Translate contentKey="merlionTestApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
