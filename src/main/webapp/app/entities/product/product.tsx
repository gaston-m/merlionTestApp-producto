  ...
  return (
    <div>
      <h2 id="product-heading">
        <Translate contentKey="merlionTestApp.product.home.title">Products</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="merlionTestApp.product.home.createLabel">Create new Product</Translate>
        </Link>
      </h2>
        ...
        {productList && productList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="merlionTestApp.product.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="merlionTestApp.product.price">Price</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="merlionTestApp.product.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>
